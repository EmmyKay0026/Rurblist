...
import Testimonial from "../../molecule/Testimonial";
import Carousel from "react-multi-carousel";
import "react-multi-carousel/lib/styles.css";
import iconright from "../../../../public/assets/iconright.svg";
import iconleft from "../../../../public/assets/iconleft.svg";
...
const TestimonialSlider = () => {
  const ButtonGroup = ({ next, previous, goToSlide, ...rest }) => {
    ...
    return (
      <div className="carousel-button-group flex gap-[40px] mt-[13px]">
        ...
        <Image
          ...
          onClick={() => previous()}
        />
        <Image src={iconright} onClick={() => next()} />
      </div>
    );
  };
